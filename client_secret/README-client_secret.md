<html>
	...
	<body>
        ...
        <h1>README - RÉPERTOIRE DU 'CLIENT SECRET'</h1>

        <hr>
        
        <strong>Ici doit être rangé le fichier du 'client_secret' (renommé 'client_secret.json'), qui doit être téléchargé via un projet créé sur l'API Gmail.
        </strong>
